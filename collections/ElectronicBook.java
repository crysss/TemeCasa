 ...
 */
public class ElectronicBook implements Comparable {
	...
	public int compareTo(Object arg0) {
		...
		ElectronicBook arg1 = (ElectronicBook)arg0;
		
		if (this.title.equals(arg1.title)) {
			return 0;
		}
		if (this.title.compareTo(arg1.title) < 0){
			return -1;
		}
		if (this.title.compareTo(arg1.title) > 0){
			return 1;
	...
	public boolean equals(Object obj) {
		ElectronicBook arg1 = (ElectronicBook)obj;
		if (this.title.equals(arg1.title)) {
			return true;
		}
		else 
